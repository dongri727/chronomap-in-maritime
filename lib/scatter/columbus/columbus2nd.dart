...
class Columbus2nd extends StatefulWidget {
  const Columbus2nd({super.key});

  @override
  Columbus2ndState createState() => Columbus2ndState();
}

class Columbus2ndState extends State<Columbus2nd> {
  ...
  Future<Map<String, List<dynamic>>> loadAndProcessData() async {
    ...
    // columbus.jsonの読み込み
    String columbusJsonString = await rootBundle.loadString('assets/json/columbus2nd.json');
    List<dynamic> columbus2ndData = json.decode(columbusJsonString);

    return {
      'coastline': coastlineData,
      'columbus2nd': columbus2ndData
    };
  }
    ...
    return '''
    {
      ...
      series: [
        ...
        },
        {
          ...
          data: ${json.encode(data['columbus2nd'])},
          label: {
                show: true,
                textStyle: {
                  fontSize: 20,
