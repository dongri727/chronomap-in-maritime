...
class Columbus1st extends StatefulWidget {
  const Columbus1st({super.key});

  @override
  Columbus1stState createState() => Columbus1stState();
}

class Columbus1stState extends State<Columbus1st> {
  ...
  Future<Map<String, List<dynamic>>> loadAndProcessData() async {
    ...
    // columbus.jsonの読み込み
    String columbusJsonString = await rootBundle.loadString('assets/json/columbus.json');
    List<dynamic> columbusData = json.decode(columbusJsonString);
    ...
    return '''
    {
      ...
      series: [
        ...
        },
        {
          ...
          data: ${json.encode(data['columbus'])},
          label: {
                show: true,
                textStyle: {
                  fontSize: 20,
